...
class SolidityVisitor(ParseTreeVisitor):
    ...
    def visitFunctionTypeParameterList(
    ...
    def visitFunctionCallArguments(
    ...
    def visitAssemblyIdentifierOrList(
    ...
    def visitAssemblyIdentifierList(
    ...
    def visitAssemblyStackAssignment(
    ...
    def visitElementaryTypeNameExpression(
